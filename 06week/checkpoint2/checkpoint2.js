...
//use .map(Number) to convertstrings to numbers
...
const weatherStates = weather.map((place) => place.weather_state_name)
console.log(weatherStates)

//find the id of the object in weather that has a min_temp of 15.915
const idealTemp = weather.filter((place) => place.min_temp === 15.915 )
